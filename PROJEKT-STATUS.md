...
- **Nicht abgedeckt (bewusst)**: eingeloggte Dashboards, echte Bewerbung, Chat, Admin - braeuchte echte Test-Accounts oder sehr grosse Auth-Mocks. Kandidat fuer spaeter (z.B. eigenes Supabase-Testprojekt oder Test-User + storageState).
